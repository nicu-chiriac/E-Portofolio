          ...
          <div className="project__container">
            <div className="row">
              <div className="column__1">
                ...
                <div className="links">
                  <BsGithub className='github__button' size={30} onClick={() => window.open('https://www.google.com', '_blank')} />🡰 Source code
                </div>
              </div>
              <div className="column__2">
                ...
                <NavLink to='/project1' scroll={scrollWithOffset}>
          ...
          <div className="project__container">
            <div className="row">
              <div className="column__1">
                ...
                <div className="links">
                  <BsGithub className='github__button' size={30} onClick={() => window.open('https://www.google.com', '_blank')} />
                  <a href='#unavailable'>
